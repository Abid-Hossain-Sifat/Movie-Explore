...
const Navbar = () => {
  return (
    <nav className="w-full bg-[#0b0f19] border-b border-slate-800/80 sticky top-0 z-50">
      <div className="navbar w-[95%] sm:w-[90%] lg:w-[80%] mx-auto px-1 sm:px-6 lg:px-8 py-2.5">
        {/* Logo */}
        <div className="navbar-start">
          <Link
            to="/"
            className="text-lg sm:text-2xl font-black tracking-tight inline-flex items-center gap-0.5 select-none hover:opacity-95 transition-opacity"
          >
        ...
        <div className="navbar-end flex items-center gap-1.5 sm:gap-3">
          <NavLink
            ...
            className={({ isActive }) =>
              `btn btn-xs sm:btn-sm rounded-full px-3 sm:px-5 text-xs sm:text-sm font-semibold tracking-wide border transition-all duration-200 ${
                isActive
